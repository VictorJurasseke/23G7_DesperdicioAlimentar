...
const CardPerfil = ({ nome, img, periodo, token, navigate, nivel_acesso }) => {
  ...
  return (
    <motion.div className="col-12 text-dark p-3 shadow-sm card-perfil"   initial={{y:"-100vh", opacity:0}} transition={{duration:"1", type:"spring", stiffness:20}} animate={{y:80, opacity:1}}>
