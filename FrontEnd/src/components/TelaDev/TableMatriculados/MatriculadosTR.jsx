...
const MatriculadosTR = ({ID_jogos,ID_usuarios, jo_nome, user_nome, pontos_usuario, rank_usuario, es_nome, BuscarTodosMatriculados, token, navigate, BuscarNaoMatriculados,setMatriculadoFiltrado,setSelectJogo  }) => {
