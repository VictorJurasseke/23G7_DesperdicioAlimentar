...
const CardPerfil = ({ nome, img, periodo, token, navigate, nivel_acesso }) => {
  ...
  return (
    <motion.div className="col-12 text-dark mt-3 p-3 shadow-sm card-perfil"  initial={{y:"-100vh", opacity:0}} transition={{duration:"2", type:"spring", stiffness:40}} animate={{y:0, opacity:1}}>
